  ...
  <div id="q-app" >
    <div v-if="getMobileMode">
      <div  id="android-preview" class="platform-android mat-only">
        <iframe id="android-iframe" frameborder="0" src="http://localhost:8080/android/#/"></iframe>
      </div>
      <div  id="ios-preview" class="platform-ios ios-only">
        <iframe id="ios-iframe" frameborder="0" src="http://localhost:8080/ios/#/"></iframe>
      </div>
    </div>
...
<script type="text/javascript">
  import toolbar from './components/layout/header.vue'
  import drawer from './components/layout/sidebar.vue'
